...
import { Briefcase, User, Mail, Phone, LogOut } from 'lucide-react-native';

export const ClientHomeScreen = ({ navigation }: { navigation: any }) => {
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          <View style={styles.iconBox}>
            <Briefcase size={36} color={COLORS.white} />
          </View>
          <Text style={styles.welcomeText}>Welcome back, Client!</Text>
          <Text style={styles.instructions}>You are successfully authenticated under the Hirer flow.</Text>
        </View>
